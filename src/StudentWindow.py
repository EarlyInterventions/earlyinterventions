...
class StudentWindow(QMainWindow):
    ...
    def setupUI(self):
        ...
        self.setWindowTitle("Student View - " + str(self.student.getID()))

        self.mainLayout = QVBoxLayout()

        self.studentLabel = QLabel("Student " + self.student.getID())
        font = QFont()
        ...
        self.scoreLabel = QLabel("Predicted to Pass: " + str(self.student.passPrediction()))
        ...
        self.overallListWidget = QListWidget()
        self.overallListWidget.setFrameShape(QFrame.Shape.NoFrame)
        self.overallListWidget.viewport().setAutoFillBackground(False)
        self.overallListWidget.setSpacing(2)
        self.overallListWidget.addItems(self.student.getTop5())

        self.overallVBox.addWidget(self.overallListWidget, 1)
